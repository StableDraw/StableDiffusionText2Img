...
if __name__ == "__main__":
    params = { 
        "version": "2.1-512-ema",   #Имя кастомной модели. Может быть "1.0-512-1-ema", "1.0-512-1-nonema", "1.0-512-2-ema","1.0-512-2-nonema","1.0-512-3-ema","1.0-512-3-nonema","1.0-512-4-ema","1.0-512-4-nonema","2.0-512", "2.0-768-v", "2.1-512-ema", "2.1-512-nonema", "2.1-768-ema", "2.1-768-nonema")   
        ...
        "use_quad": "uniform",      #Использовать квадратичный дискретизатор обработчика (по-умолчанию мультиформатный. Квадратичный обеспечивает немного другой способ обработки) (доступны "uniform" и "quad")
        "scale": 9.0,               #От 0.1 до 30.0
        "inference-v": False,       #Использовать модифицированную конфигурацию. Чаще показыватет лучшие результаты при использовании высоких значений параметра "scale". Используется только для "2.1-512-ema", "2.1-512-nonema"
        ...
        "torchscript": True,        #Использовать torchscript (только для процессоров Intel, на данный момент у меня AMD). Системный параметр
